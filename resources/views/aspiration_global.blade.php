...
<div class="card" style="background-color: #E9ECEF">
    <div class="card-body">
        <form action="{{ route('aspiration.store') }}" method="post" id="aspirationForm">
            ...
            <input type="text" name="title" id="titles" onblur="validate_title(this.value)" required class="form-control">
            <span style="color:red" id="title"></span>

            <label for="descriptions" class="mt-3">{{ __('lang.description') }}</label>
            <textarea name="description" id="descriptions" onblur="validate_description(this.value)" cols="30" rows="10" required class="form-control"></textarea>
